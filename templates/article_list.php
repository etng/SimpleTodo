...
<p class="pull-right">
  <?php if(checkPrivilege('article', 'add')):?>
  <a href="article.php?act=add" class="btn"><i class="icon-eidt"></i>发文章</a>
  <?php endif;?>
</p>
<table class="table table-bordered table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="article.php?act=view&id=<?php echo $article['id'];?>" class="btn btn-info">详情</a> <a href="article.php?act=edit&id=<?php echo $article['id'];?>" class="btn">编辑</a> <a href="article.php?act=delete&id=<?php echo $article['id'];?>" class="btn btn-danger">删除</a></td>
    </tr>
    <?php endforeach;?>
    <?php else:?>
    <tr>
