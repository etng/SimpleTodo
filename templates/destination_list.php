...
<p class="pull-right">
  <?php if(checkPrivilege('destination', 'add')):?>
  <a href="destination.php?act=add" class="btn"><i class="icon-eidt"></i>添加目的地</a>
  <?php endif;?>
</p>
<table class="table table-bordered table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="destination.php?act=view&id=<?php echo $destination['id'];?>" class="btn btn-info">详情</a> <a href="destination.php?act=edit&id=<?php echo $destination['id'];?>" class="btn">编辑</a> <a href="destination.php?act=delete&id=<?php echo $destination['id'];?>" class="btn btn-danger">删除</a></td>
    </tr>
    <?php endforeach;?>
    <?php else:?>
    <tr>
