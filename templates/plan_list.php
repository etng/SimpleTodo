...
<p class="pull-right">
  <?php if(checkPrivilege('plan', 'add')):?>
  <a href="plan.php?act=add" class="btn">添加计划</a>
  <?php endif;?>
</p>
<div> <a href="plan.php?act=list&st=all"<?php $cur_status==='all' && print ' class="active"';?>>所有</a>
  <?php
    ...
    <table class="table table-bordered table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="plan.php?act=view&id=<?php echo $plan['id'];?>" class="btn btn-info">详情</a> <a href="plan.php?act=delete&id=<?php echo $plan['id'];?>" class="btn btn-danger">删除</a></td>
        </tr>
        <?php endforeach;?>
        <?php else:?>
        <tr>
