    ...
    <div class="control-group">
      ...
      <div class="controls">
        ...
        <label class="inline radio">
          <input type="radio" id="setting_driver_star_<?php echo $i;?>" name="setting[driver_star]" value="<?php echo $i;?>"<?php $i==@$setting['driver_star'] && print(' checked="true"');?> />
          <?php echo $i;?></label>
        <?php endwhile;?>
  ...
  <fieldset>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <?php $i=0;while($i++<5):?>
        <label class="inline radio">
          <input type="radio" id="setting_hotel_star_<?php echo $i;?>" name="setting[hotel_star]" value="<?php echo $i;?>"<?php $i==@$setting['hotel_star'] && print(' checked="true"');?> />
          <?php echo $i;?></label>
        <?php endwhile;?>
        <p class="help-block"></p>
      </div>
