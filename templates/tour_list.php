...
<p class="pull-right"> <a href="tour.php?act=add" class="btn">添加线路</a> </p>
<table class="table table-bordered table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="tour.php?act=view&id=<?php echo $tour['id'];?>" class="btn btn-info">详情</a> <a href="tour.php?act=edit&id=<?php echo $tour['id'];?>" class="btn">编辑</a> <a href="tour.php?act=delete&id=<?php echo $tour['id'];?>" class="btn btn-danger">删除</a></td>
    </tr>
    <?php endforeach;?>
    <?php else:?>
    <tr>
