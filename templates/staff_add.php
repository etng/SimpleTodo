...
<form method="post" action="">
  <dl>
    ...
    <dt>用户名</dt>
    <dd>
      <input type="text" id="staff_username" name="staff[username]" value="" />
    </dd>
    <dt>论坛ID</dt>
    <dd>
      <input type="text" id="forum_uid" name="staff[forum_uid]" value="" />
    </dd>
    <dt>密码</dt>
    <dd>
    ...
    <dt>姓名</dt>
    <dd>
      <input type="text" id="staff_name" name="staff[name]" value="" />
    </dd>
    <dt>电话</dt>
    <dd>
      <input type="text" id="staff_phone" name="staff[phone]" value="" />
    </dd>
    <dt>Email</dt>
    <dd>
      <input type="text" id="staff_email" name="staff[email]" value="" />
    </dd>
    <dt>权限</dt>
    <dd>
      ...
      <label class="inline checkbox">
        <input type="checkbox" id="staff_privilege_<?php echo $privilege;?>" name="staff[privilege][]" value="<?php echo $privilege;?>" checked="true" />
        <?php echo $text;?></label>
    ...
    <dt>备注</dt>
    <dd>
      <textarea id="staff_memo" name="staff[memo]" rows="3" cols="70"></textarea>
    </dd>
  </dl>
