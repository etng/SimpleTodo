...
<label class="inline checkbox"><input type="checkbox" id="staff_privilege_<?php echo $privilege;?>" name="staff[privilege][]" value="<?php echo $privilege;?>" checked="true" /><?php echo $text;?></label>
