...
<p class="pull-right"> <a href="staff.php?act=add" class="btn">添加员工</a> </p>
<table class="table table-bordered table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="staff.php?act=view&id=<?php echo $staff['id'];?>" class="btn btn-info">详情</a> <a href="staff.php?act=edit&id=<?php echo $staff['id'];?>" class="btn">编辑</a> <a href="staff.php?act=delete&id=<?php echo $staff['id'];?>" class="btn btn-danger">删除</a></td>
    </tr>
    <?php endforeach;?>
    <?php else:?>
    <tr>
...
<form method="post" enctype="multipart/form-data" action="staff.php?act=import">
  <dl>
    ...
    <dd>
      <label>上传：
        <input type="file" id="import_staff_list_csv" name="staff_list_csv[]" />
      </label>
    </dd>
  </dl>
