...
<p class="pull-right"> <a href="hotel.php?act=add" class="btn">添加酒店</a> </p>
<div> <a href="hotel.php?act=list&did=all"<?php $did==='all' && print ' class="active"';?>>所有</a>
  ...
  <tbody>
    ...
    <tr>
      <td><label class="checkbox inline">
          <input type="checkbox" name="hotel_id[]" value="<?php echo $hotel['id'];?>" />
          <?php echo $hotel['id'];?></label></td>
      ...
      <td><?php echo 100-$hotel['priority'];?></td>
      <td><?php echo $hotel['created'];?></td>
      <td><a href="hotel.php?act=view&id=<?php echo $hotel['id'];?>" class="btn btn-info">详情</a> <a href="hotel.php?act=edit&id=<?php echo $hotel['id'];?>" class="btn">编辑</a> <a href="hotel.php?act=delete&id=<?php echo $hotel['id'];?>" class="btn btn-danger">删除</a></td>
    </tr>
    <?php endforeach;?>
    <?php else:?>
    <tr>
