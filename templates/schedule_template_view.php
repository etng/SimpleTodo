...
<dl>
  ...
  <dt>分类</dt>
  <dd><a href="schedule_template_cate.php?act=view&id= <?php echo $schedule_template['cate_id'];?>"><?php echo $schedule_template['cate_name'];?></a> </dd>
  <dt>名称</dt>
  <dd><?php echo $schedule_template['name'];?></dd>
  <dt>代号</dt>
  <dd><?php echo $schedule_template['code'];?></dd>
  <dt>需要边防证</dt>
  <dd><?php echo $schedule_template['need_passport']?'是':'否';?></dd>
  <dt>内容</dt>
