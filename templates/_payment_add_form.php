...
<form method="post" action="plan.php?act=add-payment">
  ...
  <dl>
    ...
    <dd>
      ...
      <input type="text" name="payment[plan_id]" value="" />
    </dd>
    <?php endif;?>
    <dt>类目</dt>
    <dd>
      ...
      <span>
      <input type="text" name="payment[cate]" id="payment_cate" value="" />
      </span></dd>
    <dt>金额</dt>
    <dd>
      <input type="text" name="payment[amount]" id="payment_amount" value="" />
    </dd>
    <dt>支付方式</dt>
    <dd>
      <select name="payment[via]" id="payment_via">
    ...
    <dt>备注</dt>
    <dd>
      <textarea name="payment[memo]" id="payment_memo" rows="3" cols="70"></textarea>
    </dd>
  </dl>
