...
<p class="pull-right"> <a href="driver.php?act=add" class="btn">添加司机</a> </p>
<table class="table table-bordered table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="driver.php?act=view&id=<?php echo $driver['id'];?>" class="btn btn-info">详情</a> <a href="driver.php?act=edit&id=<?php echo $driver['id'];?>" class="btn">编辑</a> <a href="driver.php?act=delete&id=<?php echo $driver['id'];?>" class="btn btn-danger">删除</a></td>
    </tr>
    <?php endforeach;?>
    <?php else:?>
    <tr>
