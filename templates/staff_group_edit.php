...
<form method="post" action="">
  <dl>
    <dt>名称</dt>
    <dd>
      <input type="text" id="staff_group_name" name="staff_group[name]" value="<?php echo $staff_group['name'];?>" />
    </dd>
    <dt>主要职能</dt>
    <dd>
      <select name="staff_group[target]" id="staff_group_target">
        ...
        <option value="<?php echo $target;?>"<?php $target==@$staff_group['target'] && print(' selected="true"');?>><?php echo $text;?></option>
        <?php endforeach;?>
      </select>
    </dd>
    <dt>办公室电话</dt>
    <dd>
      <input type="text" id="staff_group_phone" name="staff_group[phone]" value="<?php echo $staff_group['phone'];?>" />
    </dd>
    <dt>权限</dt>
    <dd>
      ...
      <label class="inline checkbox">
        <input type="checkbox" id="staff_group_privilege_<?php echo $privilege;?>" name="staff_group[privilege][]" value="<?php echo $privilege;?>"  <?php in_array($privilege, $staff_group['privileges']) && print(' checked="true"');?> />
        <?php echo $text;?></label>
    ...
    <dt>备注</dt>
    <dd>
      <textarea id="staff_group_memo" name="staff_group[memo]" rows="3" cols="70"><?php echo $staff_group['memo'];?></textarea>
    </dd>
  </dl>
  <input type="submit" />
</form>
