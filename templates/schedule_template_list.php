    ...
    <tbody>
      ...
      <tr>
        <td><label class="checkbox inline">
            <input type="checkbox" name="hotel_id[]" value="<?php echo $schedule_template['id'];?>" />
            <?php echo $schedule_template['id'];?></label></td>
        ...
        <td><?php if(checkPrivilege('schedule_template', 'view')):?>
      ...
      <?php else:?>
      <tr>
        <td colspan="100"> 暂时还没有找到相关的日程模版 </td>
      </tr>
      <?php endif;?>
    </tbody>
  </table>
