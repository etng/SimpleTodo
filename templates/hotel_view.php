...
<dl>
  ...
  <dd>
    ...
    <div id="price_add_form" style="display:none">
      <form method="post" action="hotel.php?act=add-price">
        <input type="hidden" name="price[hotel_id]" value="<?php echo $hotel['id'];?>" />
        <dl>
          <dt>起止日期</dt>
          <dd>
            <input type="text" class="input-small" name="start_date" id="price_start_date" value="" size="10" />
            至
            <input type="text" class="input-small" name="end_date" id="price_end_date" value="" size="10" />
          </dd>
          <dt>供应价</dt>
          <dd> 对外价
            <input type="text" class="input-mini" name="price[public_price]" id="price_public_price" value="" size="5" />
            成本价
            <input type="text" class="input-mini" name="price[cost]" id="price_cost" value="" size="5" />
          </dd>
          <dt>销售价</dt>
          <dd> 最低价
            <input type="text" class="input-mini" name="price[min_price]" id="price_min_price" value="" size="5" />
            默认价
            <input type="text" class="input-mini" name="price[default_price]" id="price_default_price" value="" size="5" />
            最高价
            <input type="text" class="input-mini" name="price[max_price]" id="price_max_price" value="" size="5" />
          </dd>
          <dt>房型</dt>
          <dd>
            <select name="price[room_type]" id="price_room_type">
          ...
          <dt>备注</dt>
          <dd>
            <textarea name="price[memo]" id="price_memo" rows="3" cols="70"></textarea>
          </dd>
        </dl>
