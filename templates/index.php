...
<form method="post" action="auth.php?act=login" id="frm_staff_login">
  <dl>
    ...
    <dt>密码</dt>
    <dd>
      <input type="password" id="staff_password" name="staff[password]" value=""/>
    </dd>
  </dl>
    ...
    <table class="table table-bordered table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><?php echo @$market_staff_options[$plan['market_staff_id']];?><br />
            <?php echo $plan_statuss[$plan['status']]['text'];?></td>
          <td><?php echo @$car_staff_options[$plan['car_staff_id']];?><br />
            <?php echo $car_statuss[$plan['car_status']]['text'];?></td>
          <td><?php echo @$room_staff_options[$plan['room_staff_id']];?><br />
            <?php echo $room_statuss[$plan['room_status']]['text'];?></td>
